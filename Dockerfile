FROM ubuntu
RUN apt-get update && apt-get install -y wget zlib1g-dev cmake && apt-get install -y python python-pip git && pip install --upgrade pip==9.0.3 && pip install intervaltree tornado pyaml psutil numpy
