...
def calc_stats(self):
	...
	#total_count = self._("input_info:read_count")
	#if total_count == None:
	#	total_count = 0
	#stats_out.total = total_count
	#stats_out.not_found = total_count - stats_out.correct - stats_out.wrong - stats_out.not_mapped
