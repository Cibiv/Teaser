...
def generateDataSetInfo(self,page,test):
	...
	ins_size = "None"
	if test._("input:reads_paired_end"):
		ins_size=str(test._("input_info:insert_size"))
	...
	html += "<td>" + str(test._("input_info:platform")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Read Length</th>"
	html += "<td>" + str(test._("input_info:read_length")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Read Count</th>"
	html += "<td>" + str(test._("input_info:read_count")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Sequence Divergence</th>"
	html += "<td>" + str(test._("input_info:divergence")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Paired-End</th>"
	html += "<td>" + util.yes_no(test._("input:reads_paired_end")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	...
	html += "<td>" + str(test._("input:reference")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Reads (Source File)</th>"
	html += "<td>" + str(", ".join([util.abs_path(f) for f in test._("input:reads")])) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Simulator</th>"
	html += "<td>" + str(test._("input_info:simulator")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Subsampling enabled</th>"
	html += "<td>" + util.yes_no(test._("input_info:sampling")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Sampling ratio</th>"
	html += "<td>" + str(test._("input_info:sampling_ratio")) + "</td>"
	html += "</tr>"
	html += "<tr>"
	html += "<th>Sampling region length</th>"
	html += "<td>" + str(test._("input_info:sampling_region_len")) + "</td>"
	html += "</tr>"
	html += "</tbody>"
	html += "</table>"
